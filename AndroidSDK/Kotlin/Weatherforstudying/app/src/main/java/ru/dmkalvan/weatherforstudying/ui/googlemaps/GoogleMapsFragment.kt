...
import ru.dmkalvan.weatherforstudying.databinding.FragmentGoogleMapsMainBinding
...
class GoogleMapsFragment : Fragment() {
    ...
    private fun goToAddress(
        ...
        view.post {
            setMarker(location, searchText, R.drawable.ic_baseline_location_on_24)
            map.moveCamera(
    ...
    private fun addMarkerToArray(location: LatLng) {
        val marker =
            setMarker(location, markers.size.toString(), R.drawable.ic_baseline_push_pin_24)
        markers.add(marker)
    }
